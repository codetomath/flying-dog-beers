        ...
        dcc.Tab(label='Profil-1', style={"color": "white","background": "#5D6D7E", 'textAlign': 'center', 'verticalAlign': 'middle','width':'100%', 'height' : 5, 'line-height' : 0 ,'margin-top':0 , 'margin-bottom':0 ,'margin-left' : 0,'display': 'inline-block', 'font-family': "Calibri" , 'font-size': '90%' ,'padding-left':'0%', 'justify-content': 'center', 'font-style': 'italic'},selected_style={"color": "white","background": "#1F1F25", 'textAlign': 'center', 'verticalAlign': 'middle', 'width':'100%', 'height' : 5, 'line-height' : 0 , 'margin-top':0 , 'margin-left' : 0,'display': 'inline-block', 'font-family': "Calibri" , 'font-size': '90%' ,'padding-left':'0%', 'justify-content': 'center', 'font-style': 'italic'},
                children=[
                        ...
                        html.Div([ 
                                            ...
                                            html.Div([          
                                                                html.Div([html.H1('Aylık NPL Aktarımı (M TL)', style={"color": "#5D6D7E","background": "rgba(0,0,0,0)", 'textAlign': 'center', 'width':'75%', 'display': 'inline-block', 'font-family': "Calibri" , 'font-size': '150%' ,'justify-content': 'center', 'font-style': 'italic', 'margin-top': '0%', 'margin-left': '25%'})]),  
                                                                html.Div([html.Div(id='card-output_01_apple')]),
                                                                html.Div([html.H1('Yıllık NPL Aktarımı (M TL)', style={"color": "#5D6D7E","background": "rgba(0,0,0,0)", 'textAlign': 'center', 'width':'75%', 'display': 'inline-block', 'font-family': "Calibri" , 'font-size': '150%' ,'justify-content': 'center', 'font-style': 'italic', 'margin-top': '0%', 'margin-left': '25%'})]),
                ...
                dcc.Tab(label='Profil-2', style={"color": "white","background": "#5D6D7E", 'textAlign': 'center', 'verticalAlign': 'middle','width':'100%', 'height' : 5, 'line-height' : 0 ,'margin-top':0 , 'margin-bottom':0 ,'margin-left' : 0,'display': 'inline-block', 'font-family': "Calibri" , 'font-size': '90%' ,'padding-left':'0%', 'justify-content': 'center', 'font-style': 'italic'},selected_style={"color": "white","background": "#1F1F25", 'textAlign': 'center', 'verticalAlign': 'middle', 'width':'100%', 'height' : 5, 'line-height' : 0 ,'margin-top':0 , 'margin-left' : 0,'display': 'inline-block', 'font-family': "Calibri" , 'font-size': '90%' ,'padding-left':'0%', 'justify-content': 'center', 'font-style': 'italic'},
                        ...
                        html.Div([
                                            ...
                                            html.Div([          
                                                                html.Div([html.H1('Aylık NPL Tahsilatı (M TL)', style={"color": "#5D6D7E","background": "rgba(0,0,0,0)", 'textAlign': 'center', 'width':'75%', 'display': 'inline-block', 'font-family': "Calibri" , 'font-size': '150%' ,'justify-content': 'center', 'font-style': 'italic', 'margin-top': '0%', 'margin-left': '25%'})]),  
                                                                html.Div([html.Div(id='card-output_02_apple')]),
                                                                html.Div([html.H1('Yıllık NPL Tahsilatı (M TL)', style={"color": "#5D6D7E","background": "rgba(0,0,0,0)", 'textAlign': 'center', 'width':'75%', 'display': 'inline-block', 'font-family': "Calibri" , 'font-size': '150%' ,'justify-content': 'center', 'font-style': 'italic', 'margin-top': '0%', 'margin-left': '25%'})]),
                ...
                children=[
                        ...
                        html.Div([
                                            ...
                                            html.Div(id='graph-output_03_apple', style={'display': 'inline-block', 'margin-top': '0%', 'margin-left': '20%', 'margin-right': '0%', 'margin-bottom': '0%'}, className="six columns"),
                                                                ...
                                                                html.Div(id='graph-output_03_orange', style={'display': 'inline-block', 'margin-top': '0%', 'margin-left': '0%', 'margin-right': '0%', 'margin-bottom': '0%'}, className="five columns"),
                                                                
                                                                html.Div(id='graph-output_03_banana', style={'display': 'inline-block', 'margin-top': '0%', 'margin-left': '10%', 'margin-right': '0%', 'margin-bottom': '0%'}, className="six columns"),

                                                                html.Div(id='graph-output_03_lemon', style={'display': 'inline-block', 'margin-top': '0%', 'margin-left': '0%', 'margin-right': '0%', 'margin-bottom': '0%'}, className="five columns"),
                                                                
                                                                html.Div(id='graph-output_03_cherry', style={'display': 'inline-block', 'margin-top': '0%', 'margin-left': '10%', 'margin-right': '0%', 'margin-bottom': '0%'}, className="six columns"),
                        ...
                        html.Div([                            
                                            ...
                                            html.Div([                                                
                                                                html.Div(id='graph-output_03_apricot_2', style={'display': 'inline-block', 'margin-top': '0%', 'margin-left': '2%', 'margin-right': '0%', 'margin-bottom': '0%'}),                                                
                                                ], className="two columns"), 
                                            
                                            html.Div([                                                
                                                                html.Div(id='graph-output_03_apricot_3', style={'display': 'inline-block', 'margin-top': '0%', 'margin-left': '2%', 'margin-right': '0%', 'margin-bottom': '0%'}),                                                
                                                ], className="two columns"), 
                                            
                                             html.Div([                                                
                                                                html.Div(id='graph-output_03_apricot_4', style={'display': 'inline-block', 'margin-top': '0%', 'margin-left': '2%', 'margin-right': '0%', 'margin-bottom': '0%'}),                                                
                                                ], className="two columns"),       
                                            
                                             html.Div([                                                
                                                                html.Div(id='graph-output_03_apricot_5', style={'display': 'inline-block', 'margin-top': '0%', 'margin-left': '2%', 'margin-right': '0%', 'margin-bottom': '0%'}),                                                
                                                ], className="two columns"),
                                            ...
                                            html.Div(id='graph-output_03_mango', style={'display': 'inline-block', 'margin-top': '0%', 'margin-left': '0%', 'margin-right': '0%', 'margin-bottom': '0%'}, className="six columns"),
                                            
                                            html.Div(id='graph-output_03_coconut', style={'display': 'inline-block', 'margin-top': '0%', 'margin-left': '5%', 'margin-right': '0%', 'margin-bottom': '0%'}, className="five columns")
                       ...
                       # ROW-1
                        ...
                        html.Div([
                                            ...
                                            html.Div([          
                                                                ...
                                                                html.Div(id='graph-output_06_banana', style={'display': 'inline-block', 'margin-top': '2%', 'margin-left': '2%', 'margin-right': '0%', 'margin-bottom': '0%'}, className="five columns"),

                                            

                                                                html.Div(id='graph-output_06_lemon', style={'display': 'inline-block', 'margin-top': '2%', 'margin-left': '5%', 'margin-right': '0%', 'margin-bottom': '0%', 'width':'45%'}, className="six columns"),
                                         
                                            
                                            
                                                                html.Div(id='graph-output_06_cherry', style={'display': 'inline-block', 'margin-top': '0.5%', 'margin-left': '2%', 'margin-right': '0%', 'margin-bottom': '0%'}, className="eleven columns"),
